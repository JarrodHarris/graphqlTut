...
export default function AddClientModal() {
    ...
    const [addClient] = useMutation(ADD_CLIENT, {
        ...
        update(cache, { data: { addClient } }) {
            const {clients } = cache.readQuery({ query: GET_CLIENTS }); //gets the clients in the cache
            cache.writeQuery({
                query: GET_CLIENTS,
                data: { clients: clients.concat([addClient])},  //adds the new client to the clients list in the cache
            });
        }
    })  //need to write to cache or else you would have to refresh page to see clients
